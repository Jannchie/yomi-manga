...
const isActive = computed(() => props.active && !props.loading)

const classList = computed(() => [
  baseClass,
  variantClasses[props.variant],
  sizeClasses[props.size],
  isActive.value ? 'auxline-btn-active' : null,
...
.auxline-btn-active {
  background-color: var(--auxline-bg-contrast) !important;
  color: var(--auxline-fg-contrast) !important;
}

.auxline-btn-active:hover {
  background-color: var(--auxline-bg-contrast) !important;
  color: var(--auxline-fg-contrast) !important;
}
